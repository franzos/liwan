...
- Import historical pageviews from Matomo with `liwan import matomo` (included in the official release and Docker builds)
...
- Restrict OIDC sign-up: close registration or limit new accounts to an email-domain allowlist
